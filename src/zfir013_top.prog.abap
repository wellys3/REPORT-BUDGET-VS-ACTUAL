...
* Tables                                                               *
*----------------------------------------------------------------------*
TABLES: sscrfields, bkpf, mara, acdoca, setleaf.
*----------------------------------------------------------------------*
* End - Tables                                                         *
*----------------------------------------------------------------------*
...
CONSTANTS: gc_init_dir       TYPE string VALUE '\Desktop',
           ...
           gc_company_name   TYPE text255 VALUE 'PT Evanindo',
           gc_report_title   TYPE lvc_title VALUE 'ZTemplate ABAP Program by ZRG',
           gc_report_title2  TYPE lvc_title VALUE 'Report Budget vs Actual'.
*----------------------------------------------------------------------*
...
*--Custom Global Types
TYPES: BEGIN OF gty_zfivt00004.
    INCLUDE TYPE zficd_zfir013_acdoca_cosp.
TYPES: wtg TYPE zficd_zfir013_acdoca_cosp-wtg001.
TYPES: END OF gty_zfivt00004.

*TYPES: gtt_zfivt00004 TYPE TABLE OF zficd_zfir013_acdoca_cosp.
TYPES: gtt_zfivt00004 TYPE TABLE OF gty_zfivt00004.
...
*      gwa_data         TYPE xxx.
*DATA: git_zfivt00004 TYPE TABLE OF zficd_zfir013_acdoca_cosp.
DATA: git_zfivt00004 TYPE TABLE OF gty_zfivt00004.
*----------------------------------------------------------------------*
* End - Global Variable                                                *
*----------------------------------------------------------------------*
...
SELECTION-SCREEN END OF LINE.
SELECTION-SCREEN BEGIN OF LINE.
PARAMETERS: rb99 RADIOBUTTON GROUP rb MODIF ID m00 DEFAULT 'X'.
SELECTION-SCREEN COMMENT 4(50) h001s005 MODIF ID m00.
SELECTION-SCREEN END OF LINE.
...
SELECTION-SCREEN BEGIN OF BLOCK z01 WITH FRAME TITLE h009.
SELECT-OPTIONS: s5_bukrs FOR acdoca-rbukrs MEMORY ID zfir013_s_1 NO-EXTENSION NO INTERVALS MODIF ID m91,
                s5_prctr for acdoca-prctr MEMORY ID zfir013_s_2 modif id m91,
                s5_racct FOR acdoca-racct MEMORY ID zfir013_s_3 MODIF ID m91,
                s5_budat FOR acdoca-budat MEMORY ID zfir013_s_4 MODIF ID m91 NO-EXTENSION,
                s5_rcntr FOR acdoca-rcntr MEMORY ID zfir013_s_5 MODIF ID m91,
                s5_setnm FOR setleaf-setname MEMORY ID zfir013_s_6 MODIF ID m91.
