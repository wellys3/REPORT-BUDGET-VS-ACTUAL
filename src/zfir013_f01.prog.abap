...
*{(REM)/Equine/SUPPORT/EG-WSU/EG-RAN/22082023/Cause: #1     MPDK908036
*      PERFORM f_get_data_2 CHANGING git_zfivt00004.
*}(END OF REM)/SUPPORT/EG-WSU/EG-RAN/22082023

*{(ADD)/Equine/SUPPORT/EG-WSU/EG-RAN/22082023/Cause: #1     MPDK908036
      PERFORM f_get_data_2_b CHANGING git_zfivt00004.
*}(END OF ADD)/SUPPORT/EG-WSU/EG-RAN/22082023

      IF git_zfivt00004[] IS NOT INITIAL.

        PERFORM f_prepare_data CHANGING git_zfivt00004.
