...
*    WRITE gd_run TO ld_text. CONDENSE ld_text.
    ...
    DESCRIBE TABLE git_zfivt00004 LINES DATA(ld_lines).
...
FORM f_display_data USING p_git_excel_fix TYPE gtt_excel_fix
                          ...
                          p_git_zfivt00004 TYPE gtt_zfivt00004.
  ...
  CASE gd_rb.
    ...
    WHEN 'RB99'.
      ...
      lcl_falv ?= gcl_falv=>create( EXPORTING  i_subclass = cl_abap_classdescr=>describe_by_name( p_name = 'GCL_FALV' )
                                    CHANGING ct_table = p_git_zfivt00004 ) .

      "Add title variable
      lcl_falv->title_v1 = gc_report_title2.
...
*      p_me->column( 'MANDT' )->set_no_out( 'X' ).
    ...
    WHEN 'RB99'.
      ...
      p_me->column( 'RBUKRS' )->set_key( '' ).
      p_me->column( 'GJAHR' )->set_key( '' ).
      p_me->column( 'RACCT' )->set_key( '' ).
      p_me->column( 'RACCT_DESC' )->set_key( '' ).
      p_me->column( 'PRCTR' )->set_key( '' ).
      p_me->column( 'RCNTR' )->set_key( '' ).
      p_me->column( 'AUART' )->set_key( '' ).
      p_me->column( 'AUART_DESC' )->set_key( '' ).
      p_me->column( 'OBJNR' )->set_key( '' ).
      p_me->column( 'RWCUR' )->set_key( '' ).

      p_me->column( 'RBUKRS' )->set_fix_column( iv_value = '' ).
      p_me->column( 'GJAHR' )->set_fix_column( iv_value = '' ).
      p_me->column( 'RACCT' )->set_fix_column( iv_value = '' ).
      p_me->column( 'RACCT_DESC' )->set_fix_column( iv_value = '' ).
      p_me->column( 'PRCTR' )->set_fix_column( iv_value = '' ).
      p_me->column( 'RCNTR' )->set_fix_column( iv_value = '' ).
      p_me->column( 'AUART' )->set_fix_column( iv_value = '' ).
      p_me->column( 'AUART_DESC' )->set_fix_column( iv_value = '' ).
      p_me->column( 'OBJNR' )->set_fix_column( iv_value = '' ).
      p_me->column( 'RWCUR' )->set_fix_column( iv_value = '' ).

      p_me->column( 'WSL' )->set_cfieldname( 'RWCUR' ).
      p_me->column( 'WSL' )->set_reptext( 'Actual' ).
      p_me->column( 'WSL' )->set_scrtext_s( 'Actual' ).
      p_me->column( 'WSL' )->set_scrtext_m( 'Actual' ).
      p_me->column( 'WSL' )->set_scrtext_l( 'Actual' ).

      p_me->column( 'WTG001' )->set_cfieldname( 'RWCUR' ).
      p_me->column( 'WTG001' )->set_reptext( 'Budget 01' ).
      p_me->column( 'WTG001' )->set_scrtext_s( 'Budget 01' ).
      p_me->column( 'WTG001' )->set_scrtext_m( 'Budget 01' ).
      p_me->column( 'WTG001' )->set_scrtext_l( 'Budget 01' ).

      p_me->column( 'WTG002' )->set_cfieldname( 'RWCUR' ).
      p_me->column( 'WTG002' )->set_reptext( 'Budget 02' ).
      p_me->column( 'WTG002' )->set_scrtext_s( 'Budget 02' ).
      p_me->column( 'WTG002' )->set_scrtext_m( 'Budget 02' ).
      p_me->column( 'WTG002' )->set_scrtext_l( 'Budget 02' ).

      p_me->column( 'WTG003' )->set_cfieldname( 'RWCUR' ).
      p_me->column( 'WTG003' )->set_reptext( 'Budget 03' ).
      p_me->column( 'WTG003' )->set_scrtext_s( 'Budget 03' ).
      p_me->column( 'WTG003' )->set_scrtext_m( 'Budget 03' ).
      p_me->column( 'WTG003' )->set_scrtext_l( 'Budget 03' ).

      p_me->column( 'WTG004' )->set_cfieldname( 'RWCUR' ).
      p_me->column( 'WTG004' )->set_reptext( 'Budget 04' ).
      p_me->column( 'WTG004' )->set_scrtext_s( 'Budget 04' ).
      p_me->column( 'WTG004' )->set_scrtext_m( 'Budget 04' ).
      p_me->column( 'WTG004' )->set_scrtext_l( 'Budget 04' ).

      p_me->column( 'WTG005' )->set_cfieldname( 'RWCUR' ).
      p_me->column( 'WTG005' )->set_reptext( 'Budget 05' ).
      p_me->column( 'WTG005' )->set_scrtext_s( 'Budget 05' ).
      p_me->column( 'WTG005' )->set_scrtext_m( 'Budget 05' ).
      p_me->column( 'WTG005' )->set_scrtext_l( 'Budget 05' ).

      p_me->column( 'WTG006' )->set_cfieldname( 'RWCUR' ).
      p_me->column( 'WTG006' )->set_reptext( 'Budget 06' ).
      p_me->column( 'WTG006' )->set_scrtext_s( 'Budget 06' ).
      p_me->column( 'WTG006' )->set_scrtext_m( 'Budget 06' ).
      p_me->column( 'WTG006' )->set_scrtext_l( 'Budget 06' ).

      p_me->column( 'WTG007' )->set_cfieldname( 'RWCUR' ).
      p_me->column( 'WTG007' )->set_reptext( 'Budget 07' ).
      p_me->column( 'WTG007' )->set_scrtext_s( 'Budget 07' ).
      p_me->column( 'WTG007' )->set_scrtext_m( 'Budget 07' ).
      p_me->column( 'WTG007' )->set_scrtext_l( 'Budget 07' ).

      p_me->column( 'WTG008' )->set_cfieldname( 'RWCUR' ).
      p_me->column( 'WTG008' )->set_reptext( 'Budget 08' ).
      p_me->column( 'WTG008' )->set_scrtext_s( 'Budget 08' ).
      p_me->column( 'WTG008' )->set_scrtext_m( 'Budget 08' ).
      p_me->column( 'WTG008' )->set_scrtext_l( 'Budget 08' ).

      p_me->column( 'WTG009' )->set_cfieldname( 'RWCUR' ).
      p_me->column( 'WTG009' )->set_reptext( 'Budget 09' ).
      p_me->column( 'WTG009' )->set_scrtext_s( 'Budget 09' ).
      p_me->column( 'WTG009' )->set_scrtext_m( 'Budget 09' ).
      p_me->column( 'WTG009' )->set_scrtext_l( 'Budget 09' ).

      p_me->column( 'WTG010' )->set_cfieldname( 'RWCUR' ).
      p_me->column( 'WTG010' )->set_reptext( 'Budget 10' ).
      p_me->column( 'WTG010' )->set_scrtext_s( 'Budget 10' ).
      p_me->column( 'WTG010' )->set_scrtext_m( 'Budget 10' ).
      p_me->column( 'WTG010' )->set_scrtext_l( 'Budget 10' ).

      p_me->column( 'WTG011' )->set_cfieldname( 'RWCUR' ).
      p_me->column( 'WTG011' )->set_reptext( 'Budget 11' ).
      p_me->column( 'WTG011' )->set_scrtext_s( 'Budget 11' ).
      p_me->column( 'WTG011' )->set_scrtext_m( 'Budget 11' ).
      p_me->column( 'WTG011' )->set_scrtext_l( 'Budget 11' ).

      p_me->column( 'WTG012' )->set_cfieldname( 'RWCUR' ).
      p_me->column( 'WTG012' )->set_reptext( 'Budget 12' ).
      p_me->column( 'WTG012' )->set_scrtext_s( 'Budget 12' ).
      p_me->column( 'WTG012' )->set_scrtext_m( 'Budget 12' ).
      p_me->column( 'WTG012' )->set_scrtext_l( 'Budget 12' ).

      p_me->column( 'WTG' )->set_cfieldname( 'RWCUR' ).
      p_me->column( 'WTG' )->set_reptext( 'Budget Sum' ).
      p_me->column( 'WTG' )->set_scrtext_s( 'Budget Sum' ).
      p_me->column( 'WTG' )->set_scrtext_m( 'Budget Sum' ).
      p_me->column( 'WTG' )->set_scrtext_l( 'Budget Sum' ).

      p_me->column( 'WTG012' )->set_cfieldname( 'RWCUR' ).
      p_me->column( 'WTG_SUM' )->set_reptext( 'Budget Sum 01 sd 12' ).
      p_me->column( 'WTG_SUM' )->set_scrtext_s( 'B.Sum01-12' ).
      p_me->column( 'WTG_SUM' )->set_scrtext_m( 'Budget Sum 01 sd 12' ).
      p_me->column( 'WTG_SUM' )->set_scrtext_l( 'Budget Sum 01 sd 12' ).

      p_me->column( 'WTG' )->set_col_pos( '11' ).
