...
FORM f_set_text .
  ...
  h009 = 'Selection Area'.
  %_s5_bukrs_%_app_%-text = 'Company Code'.
  %_s5_prctr_%_app_%-text = 'Profit Center'.
  %_s5_racct_%_app_%-text = 'GL Account'.
  %_s5_budat_%_app_%-text = 'Reporting Date'.
  %_s5_rcntr_%_app_%-text = 'Cost Center'.
  %_s5_setnm_%_app_%-text = 'Cost Center Group'.
